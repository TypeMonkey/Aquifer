...
public class Program {
   ...
   * 
   * Note: this also updates this Program's Subcommand representation
   *       description
   * @param description - the new description of this Program
   */
  public void setDescription(String description) {
    this.description = description;
	  getSubcommandRepr().setDescription(description);
  }
  ...
  /**
   * Adds the given Subcommand to this Program
   * @param subcommand - the Subcommand to add
   * @return true, if there's no other Subcommand that shares names
   *         with the given Subcommand.
   *         false, if there's a name conflict. 
   * 
   * Note: If this method returns false, then the Subcommand
   *       was not added to this Program
   *          
   */
  ...
  /**
   * Returns the Subcommand representation 
   * of this Program
   * @return the Subcommand representation 
   * of this Program
   */
  public Subcommand getSubcommandRepr() {
